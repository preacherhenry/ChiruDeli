...
import { useLoginAdmin, ApiError } from '@chirudeli/api-client';
...
export default function LoginPage() {
  ...
  const [phone, setPhone] = useState('+260970000001');
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-neutral-50 px-4">
      <form onSubmit={onSubmit} className="w-full max-w-sm rounded-xl bg-white p-8 shadow-sm">
        ...
        <p className="mt-4 text-center text-xs text-neutral-400">Demo login: +260970000001 / Admin123!</p>
      </form>
    </div>
  );
}
